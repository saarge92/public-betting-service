...
pub struct RegisterUserDto {
    ...
    #[validate(length(min = 8, max = 32, message = "Пароль должен быть от 8 до 32 символов"))]
    ...
    #[validate(length(min = 2, max = 100, message = "Имя должно содержать минимум 2 символа"))]
